        ...
        <div className="temppage">
          <div className="t1">
            <div className="home">
              ...
              <button onClick={addData} className="btn first">
                {" "}
                Submit{" "}
              </button>
              <div className="link-wrapper">
                <a onClick={handleLogIn} className="link hover-2" href="#">
      ...
      <div className="temppage">
        <div className="t1">
          <div className="home">
            ...
            <button onClick={handleData} className="btn first">
              Submit
            </button>
            <div className="link-wrapper">
              <a onClick={handleSignIn} className="link hover-2" href="#">
